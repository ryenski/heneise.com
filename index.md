...
<section class="wrap section" id="projects">
  ...
  <div class="works">
    ...
    <article class="work">
      <h3>MemberDrive</h3>
      <p class="role meta">Founder · Rails</p>
      <p class="desc prose">A crowdfunding platform that turns one-time donors into engaged members, with recurring giving, a donor CRM, and matching gifts under one roof. <a href="https://memberdrive.org">memberdrive.org</a></p>
    </article>

    <article class="work">
      <h3>Chesterton Academy of Tyler</h3>
      <p class="role meta">Board Treasurer</p>
...
<section class="wrap section" id="portfolio">
  <div class="section-head">
    ...
    <p class="section-note">{{ site.data.work | size }} screens from shipped products. Select any one to view it full size; arrow keys move through the set.</p>
  </div>
